...
export const home = {
  title: 'James Tannahill — PE Advisory & Value Engineering',
  description:
    'Operator-led private equity advisory for founder-led companies. Value engineering, exit preparation, and applied AI. New York. Get in touch.',
  h1: ['Operator.', 'Investor.', 'Builder.'] as const,
  subcopy:
    'Private equity advisory and value engineering for founder-led companies. Plocamium Holdings. Intelligent Capital at xAI.',
};
