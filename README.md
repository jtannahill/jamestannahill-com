...
src/
  ...
  pages/        # index, contact (hero video + form + FAQPage schema), privacy, terms, accessibility
...
- `faq-hero-1080.mp4` / `faq-hero-720.mp4`: NYC night skyline hero on `/contact` (desktop/mobile)
